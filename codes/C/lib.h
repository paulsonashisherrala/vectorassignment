...
double **calculate_X(double a, double angle);//End function declaration
...
double **calculate_P(double a,double angle)
{
	double **P=np_array(a*cos(angle),a*sin(-angle));
	return P;
}

double **calculate_Q(double a,double angle)
{
	double **Q=np_array(a*cos(angle),a*sin(angle));
	return Q;
}
